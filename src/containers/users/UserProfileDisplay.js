    ...
    <>
      ...
      <section className={styles.mainContainer}>
        ...
        <div className={styles.center}>
          ...
          <h2 id={styles.username}>{userSeedObj.username}</h2>

          <div className={styles.top}>
            <UserProfileDetails userProfileDetails={userSeedObj} />
            <div className={styles.review}>
              <ReviewList reviewList={reviewSeed} />
              <ReviewForm currentUser={userSeedObj} reviewee={userSeedObj} onChange={this.onChange} onSubmit={this.onSubmit} />
            </div>
          </div>

          <CurrentListingThumbList userListingList={listingSeed} />
        </div>
